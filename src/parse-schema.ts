import { AcceptibleInputSchema } from '@openapi-contrib/openapi-schema-to-json-schema/dist/openapi-schema-types';
...
function parseOpenApiSchema(
  ...
  Object.entries(schema.components.schemas).forEach(([key, value]) => {
    ...
    definitions[key] = toJsonSchema(value as  AcceptibleInputSchema);
  });
